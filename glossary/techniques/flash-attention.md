...
What this glossary wants you to take from its three-implementation comparison
...
implementation ships a separate [vector kernel](decode-vs-prefill.md); and **the
