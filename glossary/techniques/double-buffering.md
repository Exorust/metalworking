...
simpler kernel's smaller loop unrolls better — compiler quality beats algorithm),
**converged at 8192²** (everything is [bandwidth bound](arithmetic-intensity.md);
scheduling stops mattering).
