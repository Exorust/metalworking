...
- **Too small**: each fragment of A and B loaded from threadgroup memory feeds
  few multiplies — you're [bandwidth bound on threadgroup memory](../machine/threadgroup-memory.md)
...
predictable spill of the right operand beats a smaller tile — the boldest
