...
- **Capacity.** A Mac Studio configuration holds hundreds of GB of GPU-addressable
  ...
  this is the single biggest reason local-LLM people care about this platform at
  all.
...
What it costs: **bandwidth**. A base M5 moves ~153 GB/s, an M5 Max ~614 GB/s —
...
always comes from touching less memory — [fusion](../techniques/fusion-and-epilogues.md),
...
Practical notes: not all of RAM is GPU-wirable by default — a sysctl raises the
