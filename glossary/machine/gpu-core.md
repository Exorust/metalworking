...
**The GPU core is the M-series GPU's unit of compute — the thing that owns a register
...
about the design follows from that — Apple runs cores at low clocks and wide, tuning
...
dependent-instruction stalls than F32, which — combined with halved register
pressure — is why "use F16 everywhere" is the local wisdom. Matrix work runs
