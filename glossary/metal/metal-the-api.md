...
| Nsight Compute | nothing comparable — [Profiling](profiling.md) |

Differences of *shape* rather than vocabulary, worth internalizing early:
...
is comparatively under-documented — a gap this glossary exists to fill.
